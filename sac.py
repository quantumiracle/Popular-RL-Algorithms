...
class PolicyNetwork(nn.Module):
    ...
    def evaluate(self, state, epsilon=1e-6):
        ...
        log_prob = Normal(mean, std).log_prob(mean+ std*z.to(device)) - torch.log(1 - action.pow(2) + epsilon) #?; dim is action's dim?
...
SPARSE_REWARD=False
SCREEN_SHOT=False
env=Reacher(screen_size=1000, num_joints=NUM_JOINTS, link_lengths = LINK_LENGTH, \
