...
# GAME = 'Pendulum-v0'
S_DIM, A_DIM = 8, 2         # state and action dimension
...
class Worker(object):
    def __init__(self, wid):
        ...
        SCREEN_SHOT=False
        DETERMINISTIC=False
        self.env=Reacher(screen_size=SCREEN_SIZE, num_joints=NUM_JOINTS, link_lengths = LINK_LENGTH, \
    ...
    def work(self):
        ...
        while not COORD.should_stop():
            ...
            for t in range(EP_LEN):
                ...
                s_, r, done , _= self.env.step(a, SPARSE_REWARD, SCREEN_SHOT)
                # print('a: ',a)  # shape: []
                # print('s: ',s_) # shape: []
